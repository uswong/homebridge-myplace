...
//
// Description:
//   This script *CAN* be called by the HomeBridge plugin Cmd5 as defined in your config.json
...
// Plugin Installation:
//   - npm install [-g] Cmd5
//   - mkdir $HOME/.homebridge/Cmd5Scripts
//   - cp State.js  $HOME/.homebridge/Cmd5Scripts/State.js
//   - chmod u+x $HOME/.homebridge/Cmd5Scripts/State.js
//
// Parameters are:
...
//
// How it works:
//    A characteristic value is stored in the $HOME/.homebridge/Cmd5Scripts/Cmd5States in
...
//       will create the file .homebridge/Cmd5Scripts/Cmd5States/My_Door_MotionDetected
...
//
// *IMPORTANT* - I cannot audit commented constants.  The lib/CMD5_DEVICE_ENUM.js is what is used
...
// The files created within Cmd5StatesPath contain just a value of the accessories last state,
   ...
   case "Get":
   {
      switch( characteristic )
      {
         case "AccessControlLevel":   // 0
         {
            ...
            // Cmd5 Github pages -> http://ztalbot2000.github.io/homebridge-cmd5
