...
var CMD5_CHAR_TYPE_ENUMS =
{
   CMD5_FORMAT_TYPE_ENUM:
   {
      BOOL:                      0,
      INT:                       1,
      FLOAT:                     2,
...
module.exports =
{
   init: function ( hapFormats, hapUnits, hapPerms )
   {
      ...
      CMD5_CHAR_TYPE_ENUMS.CMD5_FORMAT_TYPE_ENUM.properties =
      {
      ...
      CMD5_CHAR_TYPE_ENUMS.CMD5_UNITS_TYPE_ENUM.properties =
      {
      ...
      CMD5_CHAR_TYPE_ENUMS.CMD5_PERMS_TYPE_ENUM.properties =
      {
