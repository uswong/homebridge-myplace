...
var CMD5_ACC_TYPE_ENUM =
{
   ...
   {
      return CMD5_ACC_TYPE_ENUM.properties[ index ].type;
   },
   accEnumIndexToLC: function( index )
   {
      return CMD5_ACC_TYPE_ENUM.properties[ index ].sche;
   },
   indexOfEnum: function( characteristicString )
   {
      let accTypeEnumIndex = -1;
      accTypeEnumIndex = CMD5_ACC_TYPE_ENUM.properties.indexOfEnum( i => i.type === characteristicString );
      if ( accTypeEnumIndex >= 0 )
         return accTypeEnumIndex;

      return CMD5_ACC_TYPE_ENUM.properties.indexOfEnum( i => i.sche === characteristicString );
   },
   ...
   add: function( api, type, description, props, validValues )
   {
      ...
      CMD5_ACC_TYPE_ENUM.properties[ CMD5_ACC_TYPE_ENUM.EOL ] =
         { "type": type,
      ...
      CMD5_ACC_TYPE_ENUM[ type ] = CMD5_ACC_TYPE_ENUM.EOL;

      CMD5_ACC_TYPE_ENUM.EOL ++;
   ...
   init: function (Characteristic)
   {
      ...
      CMD5_ACC_TYPE_ENUM.properties =
      {
         ...
         3:   { type: "Active",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.Active,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.Active,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
         ...
         9:   { type: "AirQuality",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetAirQuality,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 5,
         ...
         34:  { type: "CurrentAirPurifierState",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetAirPurifierState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 2,
         ...
         36:  { type: "CurrentDoorState",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetDoorState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 4,
         ...
         37:  { type: "CurrentFanState",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetFanState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 2,
         ...
         38:  { type: "CurrentHeaterCoolerState",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetHeaterCoolerState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 3,
         ...
         39:  { type: "CurrentHeatingCoolingState",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetHeatingCoolingState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 3,
         ...
         40:  { type: "CurrentHorizontalTiltAngle",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetHorizontalTiltAngle,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.INT,
                        allowedWordCount: 1,
         ...
         41:  { type: "CurrentHumidifierDehumidifierState",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetHumidifierDehumidifierState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 3,
         ...
         42:  { type: "CurrentMediaState",   // HomKitTypes-Television
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetMediaState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 5,
         ...
         43:  { type: "CurrentPosition",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetPosition,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        unit: Characteristic.Units.PERCENTAGE,
         ...
         44:  { type: "CurrentRelativeHumidity",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetRelativeHumidity,
                stringConversionFunction: function ( str ){ return stringToFloat( str ); },
                props: {format: Characteristic.Formats.FLOAT,
                        allowedWordCount: 1,
                        unit: Characteristic.Units.PERCENTAGE,
         ...
         45:  { type: "CurrentSlatState",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetSlatState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 2,
         ...
         46:  { type: "CurrentTemperature",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetTemperature,
                stringConversionFunction: function ( str ){ return stringToFloat( str ); },
                // Checked May 19, 2021
                props: {format: Characteristic.Formats.FLOAT,
                        allowedWordCount: 1,
         ...
         47:  { type: "CurrentTiltAngle",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetTiltAngle,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.INT,
                        allowedWordCount: 1,
                        unit: Characteristic.Units.ARC_DEGREE,
         ...
         50:  { type: "CurrentVerticalTiltAngle",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetVerticalTiltAngle,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.INT,
                        allowedWordCount: 1,
                        unit: Characteristic.Units.ARC_DEGREE,
         ...
         51:  { type: "CurrentVisibilityState",    // HomeKitTypes-Television
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.TargetVisibilityState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 1,
         ...
         84:  { type: "LockCurrentState",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.LockTargetState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 3,
         ...
         88:  { type: "LockTargetState",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.LockCurrentState,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
        ...
        100:  { type: "NetworkClientProfileControl",  // HomeKitTypes.d.ts
         ...
         144: { type: "SecuritySystemCurrentState",
                ...
                relatedCurrentAccTypeEnumIndex: null,
                relatedTargetAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.SecuritySystemTargetState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 4,
         ...
         145: { type: "SecuritySystemTargetState",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.SecuritySystemCurrentState,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
         ...
         182: { type: "TargetAirPurifierState",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentAirPurifierState,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
         ...
         183: { type: "TargetAirQuality",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.AirQuality,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
         ...
         186: { type: "TargetDoorState",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentDoorState,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
         ...
         187: { type: "TargetFanState",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentFanState,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
         ...
         188: { type: "TargetHeaterCoolerState",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentHeaterCoolerState,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
         ...
         189: { type: "TargetHeatingCoolingState",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentHeatingCoolingState,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
         ...
         190: { type: "TargetHorizontalTiltAngle",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentHorizontalTiltAngle,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.INT,
                        allowedWordCount: 1,
         ...
         191: { type: "TargetHumidifierDehumidifierState",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentHumidifierDehumidifierState,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
         ...
         192: { type: "TargetMediaState",   // HomeKitTypes-Television
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentMediaState,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
         ...
         193: { type: "TargetPosition",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentPosition,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
         ...
         194: { type: "TargetRelativeHumidity",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentRelativeHumidity,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToFloat( str ); },
                props: {format: Characteristic.Formats.FLOAT,
                        allowedWordCount: 1,
         ...
         195: { type: "TargetSlatState",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentSlatState,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
         ...
         196: { type: "TargetTemperature",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentTemperature,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToFloat( str ); },
                props: {format: Characteristic.Formats.FLOAT,
                        allowedWordCount: 1,
         ...
         197: { type: "TargetTiltAngle",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentTiltAngle,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.INT,
                        allowedWordCount: 1,
         ...
         198: { type: "TargetVerticalTiltAngle",
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentVerticalTiltAngle,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.INT,
                        allowedWordCount: 1,
         ...
         199: { type: "TargetVisibilityState",   // HomeKittypes-Television
                ...
                relatedCurrentAccTypeEnumIndex: CMD5_ACC_TYPE_ENUM.CurrentVisibilityState,
                relatedTargetAccTypeEnumIndex: null,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: Characteristic.Formats.UINT8,
                        allowedWordCount: 1,
