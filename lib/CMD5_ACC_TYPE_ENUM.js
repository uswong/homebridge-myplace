...
var CMD5_ACC_TYPE_ENUM =
{
   ...
   Cmd5indexOfEnum: function( characteristicString )
   {
      let accTypeEnumIndex = -1;
      accTypeEnumIndex = CMD5_ACC_TYPE_ENUM.properties.Cmd5indexOfEnum( i => i.type === characteristicString );
      if ( accTypeEnumIndex >= 0 )
         return accTypeEnumIndex;

      return CMD5_ACC_TYPE_ENUM.properties.Cmd5indexOfEnum( i => i.sche === characteristicString );
   },
      ...
      CMD5_ACC_TYPE_ENUM.properties =
      {
         ...
         9:   { type: "AirQuality",
                ...
                relatedTargetAccTypeEnumIndex:
                   ...
                   // CMD5_ACC_TYPE_ENUM.TargetAirQuality,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: hapFormats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 5,
         ...
         45:  { type: "CurrentSlatState",
                ...
                relatedTargetAccTypeEnumIndex:
                   // @deprecated Removed and not used anymore as of homebridge v2
                   null,
                   // CMD5_ACC_TYPE_ENUM.TargetSlatState,
                stringConversionFunction: function ( str ){ return stringToInt( str ); },
                props: {format: hapFormats.UINT8,
                        allowedWordCount: 1,
                        maxValue: 2,
